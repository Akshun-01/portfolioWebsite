...
const ComingSoon = () => {
  return (
    <div className='h-screen w-screen flex items-center justify-center overflow-hidden'>
        <h1 className='text-header-primary font-accent text-8xl z-10'>Under Construction</h1>
        <p className='text-zinc-300 font-mono text-2xl absolute bottom-16 tracking-wider'>COMING SOON ...</p>
