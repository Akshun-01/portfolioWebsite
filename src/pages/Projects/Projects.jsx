  ...
  return (
    <div className='sm:mx-10 sm:mb-12 mb-[-40px] sm:scale-100 scale-75'>
      <div className="overflow-hidden relative cursor-pointer border-[1px] border-neutral-400 rounded-md">
        ...
        <div className="">
          {props.data.links.website ? 
            <a href={props.data.links.website} target="_blank" className='absolute top-4 right-1 text-white bg-[#171717] p-2 rounded-full hover:text-lime-300 hover:bg-gray-900 mr-4'>
          ...
          {props.data.links.github ? 
            <a href={props.data.links.github} target="_blank" className='absolute bottom-2 left-2 text-white bg-[#171717] p-2 rounded-full hover:text-blue-400 hover:bg-gray-900 mr-5'>
