...
export default function HeroPage() {
  return (
    <div className="flex items-center justify-center text-white relative h-screen w-full overflow-x-hidden">
      <div className="text-left z-20 lg:translate-x-[-25vw] lg:translate-y-[-5vw]">
        <h1 className="text-2xl font-bold opacity-60 ml-2">I'm a</h1>
        <p className="text-5xl md:text-7xl lg:text-8xl font-accent absolute">    
            <Typewriter
              options={{
      ...
      <div className="absolute z-20 bottom-10 cursor-pointer">
