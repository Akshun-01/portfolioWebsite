...
const Projects = () => {
  ...
  return (
    <div className="bg-background-color text-white flex items-center justify-center relative py-12">
      ...
      {/* dividing line */}
      <div className='w-4/5 h-[1px] absolute bottom-10 translate-x-[-50%] left-1/2 bg-gradient-to-r from-transparent via-blue-400 opacity-60' />
    </div>
  )
}
