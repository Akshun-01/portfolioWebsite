...
const ContactForm = () => {
  ...
  return (
    <div className="bg-[url('./assets/contactbg.png')] bg-no-repeat bg-cover text-white flex items-center justify-center relative py-12">
        {isPhone ? 
          <VerticalText heading="Contact Us" className="absolute hidden"/> : (
              <div className="">
                <h1 className="text-2xl sm:text-4xl absolute top-24 left-1/2 translate-x-[-50%] tracking-widest opacity-70">Contact Us</h1>
              </div>
          )
        }
        <section className="">
          <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
              ...
              <form action="#" className="space-y-8">
                  <div>
                      ...
                      <input type="email" id="email" className="shadow-sm text-sm rounded-lg block w-full p-2.5 dark:bg-zinc-700 dark:border-gray-600 dark:placeholder-zinc-400 dark:text-white dark:shadow-sm-light" placeholder="name@gmail.com" required />
                  </div>
                  <div>
        ...
        {/* right daruma */}
        <div className="hidden lg:block absolute right-12">
